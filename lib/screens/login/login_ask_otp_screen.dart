...
class LoginAskOTPScreen extends StatefulWidget {
  final String phone;

  LoginAskOTPScreen({Key? key, required this.phone}) : super(key: key);

  @override
  State<LoginAskOTPScreen> createState() => _RegisterAskOTPScreenState();
}

class _RegisterAskOTPScreenState extends State<LoginAskOTPScreen> {
